  ...
  links: [
    {
      ...
      url: "public/pdfs/portfolio-fotos-corporativas.pdf",
      icon: "Images",
      variant: "secondary" as const,
    },
    {
      label: "Newborn Tradicional (até 28 dias)",
      url: "public/pdfs/newborn-tradicional.pdf",
      icon: "Images",
      variant: "secondary" as const,
    },
        {
      label: "Newborn Afetivo",
      url: "public/pdfs/newborn-natural.pdf",
      icon: "Images",
      variant: "secondary" as const,
    },
    {
      label: "Locação para Fotógrafos",
      url: "public/pdfs/locacao-para-fotografos.pdf",
      icon: "Camera",
      variant: "secondary" as const,
    },
    {
